...
from ReinforcementLearning_vTwoFlows import *
...
def main():
    ...
    initialnFlow = 2#10 #maximum number of flows that can coexist in the system (for the training)
...
#    file1.write(toFile)
    ...
    failedRL = packetsGen.generation(GM, nNode, nHost, nSwitch, myG, parameters, RL1, dotFormat)
